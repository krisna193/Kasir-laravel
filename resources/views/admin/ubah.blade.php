              ...
              <form action="/admin/update/{{$admin->id}}" method="POST">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="id_admin" class="form-control" value="{{$admin->id_admin}}">
                  </div>
                 <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" name="admin_level" class="form-control" value="{{$admin->admin_level}}">
                  </div>
                   <div class="form-group">
                    <label for="">Admin Nama</label>
                    <input type="text" name="admin_nama" class="form-control" value="{{$admin->admin_nama}}">
                  </div>
                   <div class="form-group">
                    <label for="">Admin Status</label>
                    <input type="text" name="admin_status" class="form-control" value="{{$admin->admin_status}}">
                  </div>
